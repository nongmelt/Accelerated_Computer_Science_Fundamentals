...
void DisjointSets::dsunion(int i, int j) {
  ...
  std::cout << "Root i: " << root_i << " Cycle: " << i_had_cycle <<std::endl;
  std::cout << "Root j: " << root_j << " Cycle: " << j_had_cycle <<std::endl;
  ...
  // TODO: Your work here!
  has_cycle[root_j] = i_had_cycle || j_had_cycle || has_cycle[root_i];
  std::cout << i_had_cycle << " " << j_had_cycle << std::endl;
  // if (i_had_cycle || j_had_cycle) {
  //   has_cycle[root_i] = true;
  // }
  std::cout << "Root identity: " << root_i << " Cycle: " << has_cycle[root_i] << std::endl;
  std::cout << "Root identity: " << root_j << " Cycle: " << has_cycle[root_j] << std::endl;
  std::cout << std::endl;
}
